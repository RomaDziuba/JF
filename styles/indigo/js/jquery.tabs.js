...
$.fn.tabs = function(initial, settings) {
    ...
    return this.each(function() {
        ...
        if (location.hash || $.cookie('__currentTab')) {
            tabs.each(function(i) {
            	if ((this.hash == location.hash) || (this.hash == $.cookie('__currentTab'))) {
            		settings.initial = i;
        ...
        tabs.bind('click', function(e) {
            ...
            $.cookie('__currentTab', this.hash, {path: '/'});

            //Goliath:
            if(this.attributes['topage']) {
            	window.location = this.attributes['topage'].nodeValue;
            }
